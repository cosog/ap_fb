create or replace trigger BEF_HIBERNATE_SEQUENCE_INSERT BEFORE INSERT ON TBL_DIST_ITEM
FOR EACH ROW
BEGIN
...
create or replace trigger trg_a_wellinformation_i after insert or update  on TBL_WELLINFORMATION FOR EACH ROW
declare
  pump_RT   number(10);
  tubing_RT   number(10);
begin
...
create or replace trigger trg_b_alarminfo_i   before  insert on tbl_alarminfo FOR EACH ROW
BEGIN
