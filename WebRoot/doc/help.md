...
>   [2.3.1 设备列表](#2.3.1设备列表)

>   [2.3.2 历史曲线](#2.3.2历史曲线)
...
![](../images/helpdoc/PNG/0679a7d0942af6e1af928d233121ea8e.png)
...
![](../images/helpdoc/PNG/452847e2fe2b50445548b200b3c81f24.png)

4、驱动程序路径配置，只需将IP修改位ad程序所在服务器IP即可

![](../images/helpdoc/PNG/722ac03e9e876f5e89284b36c6ecc0d6.png)

5、配置完成成后，启动驱动程序，启动tomcat。启动后，打开浏览器，访问并登录软件，按照1.5节说明进行操作。
...
3、“用户管理”模块为单位创建用户，**详情查看2.6.3节**；

4、“驱动配置”模块配置协议或者对接数据库的信息，**详情查看2.7节**；
...
![](../images/helpdoc/PNG/68f0c93645bd81ad468695382f102d04.png)
...
![](../images/helpdoc/PNG/266986c5df9977956517fd5065cce3a1.png)

图2-2 实时监控

### <h3><a name="2.2.1状态统计"></a>2.2.1 状态统计</h3>

统计设备通信状态，点击饼图相应部分或者统计表中某一行，可对设备进行状态筛选。

![](../images/helpdoc/PNG/7360108a97d33a6e46854ed56afcfa2b.png)![](../images/helpdoc/PNG/2db4586b9ad1ee6981528ea2e8d34dfa.png)

图2-3 实时监控-状态统计饼图 图2-4 实时监控-状态统计表
...
实时曲线，动态实时刷新。曲线中的内容可在驱动配置-单元配置-采控单元中配置。实时曲线只能查看当天数据，可点击时间区域显示对应曲线。

![](../images/helpdoc/PNG/ee598cc7bd139c2e5a2bab18fdf2be1b.png)
...
![](../images/helpdoc/PNG/5974b017a7b0d40011658705b2942431.png)
...
![](../images/helpdoc/PNG/61c6bb30ce26c30d7adda326b277a796.png)

图2-12 历史查询

### <h3><a name="2.3.1设备列表"></a>2.3.1 设备列表</h3>

显示设备列表以及当前通信状态和最新数据的采集时间。

![](../images/helpdoc/PNG/e96cdabb36d9847386a6fb343f9caefd.png)

图2-13 历史查询-设备列表

### <h3><a name="2.3.2历史曲线"></a>2.3.2 历史曲线</h3>

显示数据列表中所选设备的历史曲线，当历史数据记录数大于500时，显示数据抽稀后的曲线。
...
显示设备列表所选设备的历史数据，历史数据表中为设备概览数据，点击详细查看详细数据。
...
![](../images/helpdoc/PNG/273546d5ddd620b5aaaf7217d8353b10.png)
...
![](../images/helpdoc/PNG/1b9e67c56bff295303f9271d7bd800cb.png)
...
![](../images/helpdoc/PNG/b304a38a8e3d48aa430d08617d506d3a.png)
...
![](../images/helpdoc/PNG/d02d257a69f5edb4a4e069f047ccdec1.png)
...
![](../images/helpdoc/PNG/2a93ade0c422d9a4ee57c4711a1ff333.png)
...
![](../images/helpdoc/PNG/b79dd54ff5f5d645bb5406771db8b50e.png)
...
![](../images/helpdoc/PNG/7196a0c81a5800f46c6cc41e3a048d4d.png)
...
出厂编号、规格型号、生产日期、发货日期、投产日期、控制柜型号等设备信息

排序编号：设备显示顺序；

辅件设备配置：在辅件设备列表中，勾选左侧设备表中所选设备具有的辅件设备。

辅件设备的维护见“2.8.3辅件设备”部分。

注意：当需要修改设备名称时，修改后，不要点击“保存”按钮，而是点击“修改设备名称”按钮。

![](../images/helpdoc/PNG/6947b0c0985edcb3f6a32ce3f4acf2cc.png)
...
出厂编号、规格型号、生产日期、发货日期、投产日期、控制柜型号、管体长度等设备信息
...
![](../images/helpdoc/PNG/b8a3400ecf23ab04f6ae3388be9d8820.png)
